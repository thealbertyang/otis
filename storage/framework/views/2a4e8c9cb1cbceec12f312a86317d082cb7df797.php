...
<?php $__env->startSection('javascript'); ?>
    ...
    <?php if(isset($google_analytics_client_id) && !empty($google_analytics_client_id)): ?>
        ...
        <script src="<?php echo e(voyager_asset('js/ga-embed/chart.min.js')); ?>"></script>
        <script src="<?php echo e(voyager_asset('js/ga-embed/moment.min.js')); ?>"></script>
        <!-- Include the ViewSelector2 component script. -->
        <script src="<?php echo e(voyager_asset('js/ga-embed/view-selector2.js')); ?>"></script>
        <!-- Include the DateRangeSelector component script. -->
        <script src="<?php echo e(voyager_asset('js/ga-embed/date-range-selector.js')); ?>"></script>
        <!-- Include the ActiveUsers component script. -->
        <script src="<?php echo e(voyager_asset('js/ga-embed/active-users.js')); ?>"></script>
