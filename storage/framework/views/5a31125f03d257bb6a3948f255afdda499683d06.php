                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if($row->field == 'training_class_id'): ?>
                                            	<span><?php echo e(array_values(\App\CreatedTrainingClass::all()->where('id', '=', $data->training_class_id)->toArray())[0]['title']); ?></span>
                                            <?php else: ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <td>
                                        <span><?php echo e(\TCG\Voyager\Models\User::all()->where('training_class_id', '=', $data->id)->count()); ?></span>
                                    </td>
