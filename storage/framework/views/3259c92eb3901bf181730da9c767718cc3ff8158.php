      	...
      	<div class="row padding-large grey lighten-5">
      		<div class="col s12">
      			...
      			<div class="divider">
                        ...
                        <img src="<?php echo e(asset('/img/training/support-chart.jpg')); ?>" class="responsive-img padding-top materialboxed">
      		...
      		<div class="col s12">
      			<!--<img alt="" class="responsive-img" src="<?php echo e(asset('public/img/training/image002.png')); ?>" width=167px height=167px>-->
		...
		<div class="row padding-large grey lighten-5">
		    <div class="col s12">
      			...
      			<div class="divider">
                        ...
                        <img src="<?php echo e(asset('/img/training/support-chart-regional.jpg')); ?>" class="responsive-img  materialboxed">
                        <div class="divider transparent">
                        </div>
      		</div>
      		<div class="col s12">
            ...
            <div class="row">        
                  <div class="col s12 m12 l12 card">
                        <h5><img alt="" class="responsive-img img-float left" src="<?php echo e(asset('/img/training/10.jpg')); ?>"> Building Your Personal Otis Support Network</h5>            
