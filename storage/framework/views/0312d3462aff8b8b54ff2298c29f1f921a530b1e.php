                            ...
                            <div class="form-group">
                                ...
                                <select name="role_id" id="role" class="">
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($role->id); ?>" <?php if((isset($dataTypeContent) && $dataTypeContent->role_id == $role->id) || (!isset($dataTypeContent) && $role->id == 2)): ?> selected <?php endif; ?>><?php echo e($role->display_name); ?></option>
                                        <?php if(!isset($dataTypeContent) && $role->id == 2): ?> selected <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>

                            <div class="form-group">
                                <label for="training_class_id">Training Program</label>
                                <select name="training_class_id" id="role" class="">
                                        <option value="">Select Training Program</option>
                                    <?php $trainingClass = \App\TrainingClass::all(); ?>
                                    <?php $__currentLoopData = $trainingClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainingClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($trainingClass->id); ?>" <?php if(isset($dataTypeContent) && $dataTypeContent->training_class_id == $trainingClass->id): ?> selected <?php endif; ?>><?php echo e($trainingClass->title); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
