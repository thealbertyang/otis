...
@endphp
	        ...
	        <div class="col s12 m12 l12">
	        	...
	        	<div class="col s12 m12 l4 mobile-margin-bottom">
	        		<div class="col s12 center-align">
	        			<img alt="" class="responsive-img circle white" src="{{asset('/img/training/image005.png')}}" width=167px height=167px>
	        	...
	        	<div class="col s12 m12 l4 mobile-margin-bottom">
	        		<div class="col s12 center-align">
	        			<img alt="" class="responsive-img circle white" src="{{asset('/img/training/image004.png')}}" width=167px height=167px>
	        	...
	        	<div class="col s12 m12 l4 mobile-margin-bottom">
	        		<div class="col s12 center-align">
	        			<img alt="" class="responsive-img circle white" src="{{asset('/img/training/image007.png')}}" width=167px height=167px>
	    ...
	    @if ($forms2)
	    <form method="POST" action="{{Request::url()}}" class="row form-regional-list grey lighten-5 padding-large">  
	   	{{ csrf_field() }}
	   	<input type="hidden" name="form_type" value="regional_list">
	   	<input type="hidden" name="totalCount" value="{{ isset($form['regional-list']['totalCount']) ? $form['regional-list']['totalCount'] : 0 }}">
	        <div class="col s12 m12 l12">
	        ...
	        <div class="divider mobile-margin-bottom"></div>
	        	...
	        	<div class="col s12 m12 l12 mobile-margin-bottom">
	        		<div class="col s12 center-align">
	        			<img alt="" class="responsive-img circle white" src="{{asset('/img/training/image012.jpg')}}" width=167px height=167px>
	        		</div>
	        		
	          		<input type="text" name="list_regional_members[]" value="{{ isset($form['regional-list']['list_regional_members'][0]) ? $form['regional-list']['list_regional_members'][0] : '' }}">
	          		<input type="text" name="list_regional_members[]" value="{{ isset($form['regional-list']['list_regional_members'][1]) ? $form['regional-list']['list_regional_members'][1] : '' }}">
	          		<input type="text" name="list_regional_members[]" value="{{ isset($form['regional-list']['list_regional_members'][2]) ? $form['regional-list']['list_regional_members'][2] : '' }}">
	          		<input type="text" name="list_regional_members[]" value="{{ isset($form['regional-list']['list_regional_members'][3]) ? $form['regional-list']['list_regional_members'][3] : '' }}">
	          		<input type="text" name="list_regional_members[]" value="{{ isset($form['regional-list']['list_regional_members'][4]) ? $form['regional-list']['list_regional_members'][4] : '' }}">
	          		<input type="text" name="list_regional_members[]" value="{{ isset($form['regional-list']['list_regional_members'][5]) ? $form['regional-list']['list_regional_members'][5] : '' }}">
	          		<input type="text" name="list_regional_members[]" value="{{ isset($form['regional-list']['list_regional_members'][6]) ? $form['regional-list']['list_regional_members'][6] : '' }}">
