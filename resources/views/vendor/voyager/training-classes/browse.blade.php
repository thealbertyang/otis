                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            ...
                                            @endif
                                            @if($row->field == 'training_class_id')
                                            	<span>{{ array_values(\App\CreatedTrainingClass::all()->where('id', '=', $data->training_class_id)->toArray())[0]['title'] }}</span>
                                            @else
                                    ...
                                    @endforeach
                                    <td>
                                        <span>{{ \TCG\Voyager\Models\User::all()->where('training_class_id', '=', $data->id)->count()  }}</span>
                                    </td>
