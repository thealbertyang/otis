                    ...
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">                            
                            ...
                            <div class="form-group">
                                ...
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'folder_path',
                                    '_field_trans' => get_field_translations($dataTypeContent, 'folder_path')
                                ])
                                <input type="text" class="form-control" id="title" name="folder_path" placeholder="Folder" value="@if(isset($dataTypeContent->folder_path)){{ $dataTypeContent->folder_path }}@endif">
                            </div>
                            <div class="form-group">
